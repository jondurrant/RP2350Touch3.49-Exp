...
void _lv_disp_refr_timer(lv_timer_t * tmr)
{
    ...
    if(perf_label == NULL) {
        ...
        lv_obj_set_style_pad_top(perf_label, 0, 0);
        lv_obj_set_style_pad_bottom(perf_label, 0, 0);
        lv_obj_set_style_pad_left(perf_label, 0, 0);
        lv_obj_set_style_pad_right(perf_label, 0, 0);
        lv_obj_set_style_text_align(perf_label, LV_TEXT_ALIGN_RIGHT, 0);
        lv_label_set_text(perf_label, "?");
        lv_obj_set_width(perf_label, 120); 
    ...
    if(mem_label == NULL) {
        ...
        lv_obj_set_style_pad_top(mem_label, 0, 0);
        lv_obj_set_style_pad_bottom(mem_label, 0, 0);
        lv_obj_set_style_pad_left(mem_label, 0, 0);
        lv_obj_set_style_pad_right(mem_label, 0, 0);
        lv_label_set_text(mem_label, "?");
        lv_obj_align(mem_label, LV_USE_MEM_MONITOR_POS, 1, 1);
    }
